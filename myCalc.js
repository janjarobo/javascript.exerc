...
let ouputLower = document.querySelector('#lower');

/*this function is if num button is clicked
it will check lowerOutput
if lowerOutput === 0 then pressed num button will be replaced 
if lowerOuput /== 0 the pressed num button will be added*/
function pressNum(e) {
